    ...
    <div class="max-w-5xl xl:max-w-6xl mx-auto pt-12 px-[2%] pb-8 lg:my-[200px]">
        ...
        <div class="w-full lg:max-w-7xl mx-auto mt-8">
            <swiper :pagination="{type: 'progressbar',}" :navigation="true" :modules="modules" :keyboard="true" :cssMode="true" class="mySwiper">
                ...
                <div class="md:basis-full md:mt-10 lg:basis-[90%] relative mx-auto items-center flex">
                    <!-- img  -->
                    <img class="w-full border" :src="require(`@/assets/images/${e.img}`)">
                    <img :src="require(`@/assets/images/clip_icon2.svg`)" alt="클립" class="absolute -top-4 left-2 w-4 md:w-[40px] md:-top-10 md:left-4">
                </div>
                <div class="basis-full md:basis-[90%] lg:basis-[52%] pt-10 md:flex md:justify-center">
                    <div class="md:basis-full">
                        <h3 class="text-2xl text-[#5d6ab1] font-bold pt-[10px] pb-[10px] md:pl-[50px] md:text-3xl">
                            {{ e.descTitle }} | {{ e.date }}
                        </h3>
