<template>
    <div class="w-full bg-white dark:bg-[#1d1c21] dark:text-[#d9d9d9] py-4 text-center text-[10px] lg:text-lg xl:text-sm">
        ...
        <div class="bottom text-[10px] border-t border-t-[#999] lg:text-lg xl:text-sm">
